...
// Task 19.
// Получите div.out-19 в переменную out19.
//  Выведите в консоль out19. Теперь получите в эту же переменную out19 блок div c классом out-19-test. 
// Выведите переменную out19 в консоль. Изучите что изменилось.
let out19 = document.querySelector('.out-19-text');
console.log(out19);// результат :null;

// Получите div.out-20 в переменную out20.
//  C помощью textContent запишите в него строку '<h2>Hi</h2>'. 
