...
// Выведите на страницу  в .out-4 результат сложения e1 + f1. Объясните разницу.
let e1 = '3';
let f1 = 5;
document.querySelector('.out-4').textContent = e1 + f1;
//в таск-3 сложение чисел, а таск-4 e1-єто строка; вот и разница  = строка добавилась к цифре 
...
let e2 = 3;
let f2 = 0;
document.querySelector('.out-5').textContent = e2 / f2;//на ноль делить нельзя поєтому 
...
function t9() {
    let userInput = document.querySelector('.i-9').value; // Получаем значение из input
    document.querySelector('.out-9').innerHTML = userInput; // Выводим в div
    document.querySelector('.i-9').value = ''; // Очищаем input
}
...
function t10() {
    let userInput = document.querySelector('.i-10').value; // Получаем значение из input
    document.querySelector('.out-10').innerHTML = userInput * 20; // Выводим в div
    document.querySelector('.i-10').value = ''; // Очищаем input
}
...
function t11() {
    let userInput = document.querySelector('.i-11');// value всегда получаем внутри функции поєтому ошибка
    document.querySelector('.out-11').innerHTML = userInput + 55; // Выводим в div
...
function t12() {
    let userName = document.querySelector('.i-12-1').value; // Получаем значение из input
    let userLastname = document.querySelector('.i-12-2').value; // Получаем значение из input

    document.querySelector('.out-12').innerHTML = ("Hello" + " " + userName + " " + userLastname);// Выводим в div
}
...
function t13() {
    ...
    // Используем parseFloat(), чтобы преобразовать строки в числа.
    let a = parseFloat(document.querySelector('.i-13-1').value); // Получаем значение из input
    let b = parseFloat(document.querySelector('.i-13-2').value); // Получаем значение из input
    let sum = a + b;
    document.querySelector('.out-13').innerHTML = sum;// Выводим в div
}
...
function t14() {
    document.querySelector('.i-14').value = 'Go'; // Заменяем значение в input
}
...
function t15() {
    document.querySelector('.i-15').style.border = "4px solid red"; // Заменяем значение в input
}
...
function t16() {//сложение работает как объединение строк
    let o = document.querySelector('.i-16-1').value; // Получаем значение из input
    let p = document.querySelector('.i-16-2').value; // Получаем значение из input

    document.querySelector('.out-16').innerHTML = o + p;// Выводим в div
...
// Task 19.
// По нажатию кнопки .b-19 функция t19 дожна в out-19 вывести 
// сумму двух отрицательных чисел из input .i-19-1 и .i-19-2. 

function t19() {
    let l = parseFloat(document.querySelector('.i-19-1').value);
    let t = parseFloat(document.querySelector('.i-19-2').value);
    document.querySelector('.out-19').innerHTML = l + t;
}
